...
public class StatGetterWaveLength implements IStatGetter {
    public StatGetterWaveLength() {
    }
    ...
    public double getValue(Player player, ItemStack itemStack) {
        if (itemStack.getItem() instanceof ModularLaserArtilleryItem artilleryItem) {
            return CompositeSpectralPowerAttribute.RGBToWaveLength(artilleryItem.getCrystalRGB(itemStack));
        } else return 0;
    }
